...
if __name__ == '__main__':
    ...
    parser.add_argument('-r', '--result_json', type=str)
    parser.add_argument('-q', '--question_json', type=str)
    parser.add_argument('-a', '--annotation_json', type=str)
    args = parser.parse_args()

    import pdb; 

    compute_vqa_accuracy(args.result_json, args.question_json, args.annotation_json)
